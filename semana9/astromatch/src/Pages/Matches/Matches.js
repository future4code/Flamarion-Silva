...
const Matches = (props)=>{    
    ...
    return <Quadro>
        ...
        <Head>                  
            <Return style={{cursor: 'pointer', fontSize:'20pt', marginLeft:'15px', color:'#388E8E'}} onClick={()=> props.changeScreen('home')} />
            <DeleteIcon onClick={clearMatches} style={{fontSize:'20pt', color:'purple', position:'absolute', left:'165px', cursor:'pointer'}} />
